# bluepy_and_circuitpython
Example on integration of custom BLE Service and Characteristic using  bluepy and circuitpython

# bluepy examples using nRF51822 width mbed

This rspository contain examples on how to use bluepy to comminicate width the nRF52840-Dongle(PCA0059) using CircuitPython<br>
...
<br> Expected output when running the CircuitPython example bluepy_and_circuitpython/circuitPython/ble_hw_device_write_leds_read_buttons.py
```text
...
<br> 
<br> 
Expected output when running the CircuitPython example bluepy_and_circuitpython/circuitPython/ble_hw_device_write_leds_read_buttons.py
```text
nRF5x
```
#####readButton1.py
